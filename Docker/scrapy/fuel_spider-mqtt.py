...
class FuelSpider(scrapy.Spider):
    ...
    # MQTT setup
    mqtt_broker = "192.168.2.249"
    mqtt_port = 1883
    mqtt_user = "buurmans"
    mqtt_password = "buurmans"
    mqtt_topic = "homeassistant/sensor/fuel_prices"
    ...
    def publish_to_mqtt(self, data):
        ...
        data_json = str(data).replace("'", '"')  # Ensure proper JSON formatting
        
        # Publish the data to the MQTT topic
        client.publish(self.mqtt_topic, data_json)
